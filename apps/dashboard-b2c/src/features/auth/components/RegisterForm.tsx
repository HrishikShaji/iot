...
import { ValidatedInvitation } from "../lib/validateInvitation"
...
export default function RegisterForm({ invitation, invitationToken }: Props) {
						...
						{invitation && (
							<div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
								<p className="text-sm text-blue-800">
									<strong>{invitation.inviter.email}</strong> has invited you to access their trailer: <strong>{invitation.trailer.name}</strong> as a <strong>{invitation.role.name}</strong>
								</p>
							</div>
						)}
					</CardDescription>
